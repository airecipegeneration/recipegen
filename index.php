    ...
    <?php if (!$is_logged_in): ?>
        ...
        <section class="relative bg-white overflow-hidden">
                ...
                <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    ...
                    <div class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div class="sm:text-center lg:text-left">
                            ...
                            <p
                                class="mt-3 text-base text-text-secondary sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                Stop wasting food. Just list the ingredients you have, and our smart AI will generate a
                                custom, delicious recipe for you in seconds. Complete with photos and step-by-step
                                instructions.
                            </p>
                            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                <div class="rounded-md shadow">
                                    <a href="<?php echo $base_path; ?>register"
                                        class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-primary-hover md:py-4 md:text-lg md:px-10">
                                        Buy Now
                                    </a>
                                </div>
                                <div class="mt-3 sm:mt-0 sm:ml-3">
                                    <a href="#features"
                                        class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-primary bg-green-100 hover:bg-green-200 md:py-4 md:text-lg md:px-10">
                                        How it Works
                                    </a>
                                </div>
                            </div>
            ...
            <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
                    src="<?php echo $base_path; ?>images/hero_background.webp"
                    alt="A beautiful display of fresh ingredients for cooking">
            </div>
        </section>
                            ...
                            <article class="home-sample-card" data-id="<?php echo $sampleId; ?>" data-aos="fade-up">
                                <figure class="home-sample-card__cover">
                                    <img src="<?php echo htmlspecialchars($coverPath); ?>"
                                        alt="<?php echo htmlspecialchars($coverAlt); ?>" width="480" height="320" loading="lazy"
                                        decoding="async">
                                </figure>
                                <div class="home-sample-card__body">
                                    <h3><?php echo htmlspecialchars($sample['title']); ?></h3>
                                    <p class="home-sample-card__description"><?php echo htmlspecialchars($sample['description']); ?>
                                    </p>
                                    ...
                                    <div class="home-sample-card__cta">
                                        <a href="<?php echo $base_path; ?>samples.php#<?php echo $sampleId; ?>"
                                            class="home-btn home-btn--secondary" data-ev="home_sample_view"
                                            data-id="<?php echo $sampleId; ?>">
                                            View details
                                        </a>
                                        <a href="<?php echo htmlspecialchars($generateUrl); ?>" class="home-btn home-btn--primary"
                                            data-ev="home_sample_generate" data-id="<?php echo $sampleId; ?>">
                                            Generate similar
                                        </a>
                                    </div>
                                </div>
                    ...
                    <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                        ...
                        <div class="relative" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <dd class="mt-2 ml-16 text-base text-text-secondary">
                                Simply type, paste, or even upload a photo of your ingredients. Our AI will identify them
                                and create a recipe.
                            </dd>
                        </div>
                        ...
                        <div class="relative" data-aos="fade-up" data-aos-delay="150">
                            ...
                            <dd class="mt-2 ml-16 text-base text-text-secondary">
                                Need a vegan breakfast? A gluten-free Italian dinner? Specify your dietary needs, cuisine
                        ...
                        <div class="relative" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <dd class="mt-2 ml-16 text-base text-text-secondary">
                                Every recipe you generate comes as a beautifully formatted PDF file, complete with a photo,
                        ...
                        <div class="relative" data-aos="fade-up" data-aos-delay="250">
                            ...
                            <dd class="mt-2 ml-16 text-base text-text-secondary">
                                All your generated recipes are automatically saved to your personal account. Access your
                                creations anytime, anywhere.
                            </dd>
                        </div>
                    </dl>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="home-card" data-aos="fade-up">
                    ...
                    <ul class="home-allergens__list">
                        <li><strong>14 EU allergens</strong> — gluten, crustaceans, eggs, fish, peanuts, soy, milk, tree
                            nuts, celery, mustard, sesame, sulphites, lupin, molluscs.</li>
                        <li><strong>Exclude &amp; swap</strong> — we avoid flagged ingredients and propose alternatives.
                        </li>
                    ...
                    <a href="<?php echo $base_path; ?>allergens.php" class="home-btn home-btn--primary"
        ...
        <section id="pricing" class="relative py-20 bg-white overflow-hidden">
            ...
            <div class="animated-bg-container">
                <span class="bg-icon"
                    style="background-image: url('<?php echo $base_path; ?>images/food-icon-1.png');"></span>
                <span class="bg-icon"
                    style="background-image: url('<?php echo $base_path; ?>images/food-icon-2.png');"></span>
                <span class="bg-icon"
                    style="background-image: url('<?php echo $base_path; ?>images/food-icon-3.png');"></span>
                <span class="bg-icon"
                    style="background-image: url('<?php echo $base_path; ?>images/food-icon-4.png');"></span>
                <span class="bg-icon"
                    style="background-image: url('<?php echo $base_path; ?>images/food-icon-5.png');"></span>
                <span class="bg-icon"
                    style="background-image: url('<?php echo $base_path; ?>images/food-icon-6.png');"></span>
                <span class="bg-icon"
                    style="background-image: url('<?php echo $base_path; ?>images/food-icon-7.webp');"></span>
            </div>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    class="relative z-10 mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-4">
                    <!-- Pricing Plan 1 -->
                    <div class="bg-surface border border-border rounded-lg shadow-sm divide-y divide-border transition transform hover:-translate-y-2 hover:shadow-xl hover:border-primary"
                        ...
                        <div class="p-6">
                            ...
                            <p class="mt-4 text-4xl font-extrabold text-text-main">
                                <?php echo format_price(calculate_price_for_tokens(1000, $current_currency), $current_currency); ?>
                            </p>
                            <p class="mt-4 text-lg font-medium text-primary">1,000 Tokens</p>
                            <a href="<?php echo $base_path; ?>register"
                                class="mt-6 block w-full bg-primary border border-transparent rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-primary-hover">Buy
                                Now</a>
                        </div>
                        <div class="pt-6 pb-8 px-6">
                            <h3 class="text-xs font-medium text-text-main tracking-wide uppercase">What's included</h3>
                            <ul class="mt-4 space-y-2">
                                <li class="flex items-start"><span class="h-6 flex items-center sm:h-7"><svg
                                            class="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                                                clip-rule="evenodd" />
                                        </svg></span><span class="ml-3 text-sm text-text-secondary">~20 Recipe
                                        Generations</span></li>
                                <li class="flex items-start"><span class="h-6 flex items-center sm:h-7"><svg
                                            class="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                                                clip-rule="evenodd" />
                                        </svg></span><span class="ml-3 text-sm text-text-secondary">PDF Downloads</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <!-- Pricing Plan 2 (Popular) -->
                    <div class="relative bg-surface border-2 border-primary rounded-lg shadow-xl divide-y divide-border transition transform hover:-translate-y-2"
                        data-aos="fade-up" data-aos-delay="150">
                        <div class="absolute top-0 right-0">
                            <div class="w-32 h-32 flex items-start justify-end">
                                <div
                                    class="absolute transform rotate-45 bg-primary text-center text-white font-semibold py-1 right-[-34px] top-[32px] w-[170px]">
                                    Popular</div>
                            </div>
                        </div>
                        <div class="p-6">
                            ...
                            <p class="mt-4 text-4xl font-extrabold text-text-main">
                                <?php echo format_price(calculate_price_for_tokens(2750, $current_currency), $current_currency); ?>
                            </p>
                            <p class="mt-4 text-lg font-medium text-primary">2,750 Tokens <span
                                    class="text-sm font-normal text-primary-hover">(+10% Bonus)</span></p>
                            <a href="<?php echo $base_path; ?>register"
                                class="mt-6 block w-full bg-primary border border-transparent rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-primary-hover">Buy
                                Now</a>
                        </div>
                            ...
                            <ul class="mt-4 space-y-2">
                                <li class="flex items-start"><span class="h-6 flex items-center sm:h-7"><svg
                                            ...
                                            <path fill-rule="evenodd"
                                                d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                                                clip-rule="evenodd" />
                                        </svg></span><span class="ml-3 text-sm text-text-secondary">~55 Recipe
                                        Generations</span></li>
                                <li class="flex items-start"><span class="h-6 flex items-center sm:h-7"><svg
                                            class="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="bg-surface border border-border rounded-lg shadow-sm divide-y divide-border transition transform hover:-translate-y-2 hover:shadow-xl hover:border-primary"
                        ...
                        <div class="p-6">
                            ...
                            <p class="mt-4 text-4xl font-extrabold text-text-main">
                                <?php echo format_price(calculate_price_for_tokens(6000, $current_currency), $current_currency); ?>
                            </p>
                            <p class="mt-4 text-lg font-medium text-primary">6,000 Tokens <span
                                    class="text-sm font-normal text-primary-hover">(+20% Bonus)</span></p>
                            <a href="<?php echo $base_path; ?>register"
                                class="mt-6 block w-full bg-primary border border-transparent rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-primary-hover">Buy
                                Now</a>
                        </div>
                            ...
                            <ul class="mt-4 space-y-2">
                                <li class="flex items-start"><span class="h-6 flex items-center sm:h-7"><svg
                                            ...
                                            <path fill-rule="evenodd"
                                                d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                                                clip-rule="evenodd" />
                                        </svg></span><span class="ml-3 text-sm text-text-secondary">~120 Recipe
                                        Generations</span></li>
                                <li class="flex items-start"><span class="h-6 flex items-center sm:h-7"><svg
                                            class="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <!-- Pricing Plan 4 -->
                    <div id="custom-pricing-card"
                        class="bg-surface border border-dashed border-border rounded-lg shadow-sm flex flex-col transition transform hover:-translate-y-2 hover:shadow-xl hover:border-primary"
                        ...
                        <div class="p-6 flex-grow">
                            ...
                            <div class="mt-8 text-center">
                                <button type="button"
                                    class="select-custom-btn w-full bg-surface border border-border rounded-md py-2 text-sm font-semibold text-primary text-center hover:border-primary">
                                    Choose Amount
                                </button>
                            </div>

                            <!-- This form is hidden by default and shown on click -->
                            <form action="<?php echo $base_path; ?>top-up" method="POST"
                                class="custom-amount-form hidden mt-6">
                                <label for="custom-amount" class="block text-sm font-medium text-text-secondary">Amount in
                                    <?php echo $current_currency; ?> (<?php echo $currency_config['symbol']; ?>)</label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <span
                                            class="text-text-secondary sm:text-sm"><?php echo $currency_config['symbol']; ?></span>
                                    </div>
                                    <input type="text" name="amount" id="custom-amount"
                                        class="focus:ring-primary focus:border-primary block w-full pl-7 pr-12 sm:text-sm border-border rounded-md"
                                        placeholder="15.00" inputmode="decimal">
                                </div>

                                <button type="submit" name="custom_purchase" value="true"
                                    class="mt-4 w-full bg-primary border border-transparent rounded-md py-2 text-sm font-semibold text-white text-center hover:bg-primary-hover">
                                    Buy Now
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="pt-6 pb-8 px-6 bg-gray-50 rounded-b-lg">
                            ...
                            <ul class="mt-4 space-y-2">
                                <li class="flex items-start">
                                    <span class="h-6 flex items-center sm:h-7"><svg
                                            class="flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                ...
                <div class="home-card home-estimator" data-aos="fade-up">
                    ...
                    <form class="home-estimator__form" id="home-estimator-form" novalidate>
                        <div class="home-field">
                            ...
                            <input type="number" id="home-estimator-portions" name="portions" min="0" step="0.1" value="5.5"
                                data-ev="home_estimator_change" inputmode="decimal">
                        </div>
                        <div class="home-field">
                            ...
                            <input type="number" id="home-estimator-grams" name="grams" min="0" step="10" value="250"
                                data-ev="home_estimator_change" inputmode="decimal">
                        </div>
                        <div class="home-field">
                            <label class="sr-only" for="home-estimator-price">€ per kg (local)</label>
                            <span class="home-field__label">€ per kg (local)</span>
                            <input type="number" id="home-estimator-price" name="price" min="0" step="0.1" value="6"
                                data-ev="home_estimator_change" inputmode="decimal">
                        </div>
                    </form>
        ...
        <section class="py-20 bg-gray-50 border-t border-border">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:text-center" data-aos="fade-up">
                    ...
                    <p class="mt-4 max-w-2xl text-xl text-text-secondary lg:mx-auto">
                        This is the exact interface you'll use. The fields are disabled, but you can see how simple it is.
                ...
                <div class="home-card home-faq" data-aos="fade-up">
                    ...
                    <div class="home-faq__items" role="list">
                        <div class="home-faq__item" role="listitem">
                            <button class="home-faq__btn" type="button" aria-expanded="false"
                                aria-controls="home-faq-panel-1" id="home-faq-1">
                                <span>Do I need a subscription?</span>
                                <svg class="home-faq__icon" viewBox="0 0 24 24" aria-hidden="true">
                                    <path d="M12 5v14M5 12h14" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </button>
                            <div class="home-faq__panel" id="home-faq-panel-1" role="region" aria-labelledby="home-faq-1"
                                hidden>
                        ...
                        <div class="home-faq__item" role="listitem">
                            <button class="home-faq__btn" type="button" aria-expanded="false"
                                aria-controls="home-faq-panel-2" id="home-faq-2">
                            ...
                            <div class="home-faq__panel" id="home-faq-panel-2" role="region" aria-labelledby="home-faq-2"
                                hidden>
                        ...
                        <div class="home-faq__item" role="listitem">
                            <button class="home-faq__btn" type="button" aria-expanded="false"
                                aria-controls="home-faq-panel-3" id="home-faq-3">
                            ...
                            <div class="home-faq__panel" id="home-faq-panel-3" role="region" aria-labelledby="home-faq-3"
                                hidden>
        ...
        <section class="relative py-12 bg-gray-50 min-h-screen overflow-hidden">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center" data-aos="fade-in">
                    ...
                    <p class="mt-2 text-lg text-text-secondary">Let's turn your ingredients into a meal,
                        <?php echo htmlspecialchars($current_user_data['first_name']); ?>!
                    </p>
                </div>
